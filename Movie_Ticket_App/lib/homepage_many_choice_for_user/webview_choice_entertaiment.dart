...
class WebViewChoiceEntertaiment extends StatefulWidget {
  const WebViewChoiceEntertaiment({super.key});

  @override
  State<WebViewChoiceEntertaiment> createState() =>
      _WebViewChoiceEntertaimentState();
}

class _WebViewChoiceEntertaimentState extends State<WebViewChoiceEntertaiment> {
        ...
        child: BlocBuilder<HomepageChoiceBloc, HomepageChoiceState>(
          builder: (context, state) {
            ...
            if (state is HomepageChoiceStateLoaded) {
              return inAppWebView(item: state.datas[0]);
            }
