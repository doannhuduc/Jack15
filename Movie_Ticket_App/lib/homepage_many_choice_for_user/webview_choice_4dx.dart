...
class WebViewChoice4dx extends StatefulWidget {
  const WebViewChoice4dx({super.key});

  @override
  State<WebViewChoice4dx> createState() => _WebViewChoice4dxState();
}

class _WebViewChoice4dxState extends State<WebViewChoice4dx> {
        ...
        child: BlocBuilder<HomepageChoiceBloc, HomepageChoiceState>(
          builder: (context, state) {
            ...
            if (state is HomepageChoiceStateLoaded) {
              return inAppWebView(item: state.datas[5]);
            }
